            ...
            <div className="space-y-6">
              <div className="flex items-center justify-between">
                <h3 className="text-lg font-medium text-gray-900">
                  Select Questions ({selectedQuestions.length}/6)
                </h3>
              ...
              {selectedQuestions.length > 0 && (
                <div className="bg-green-50 border border-green-200 rounded-lg p-4">
                  <p className="text-sm text-green-800">
                    <strong>Selected Questions:</strong> {selectedQuestions.length}/6
                  </p>
                  <p className="text-xs text-green-600 mt-1">
                    {6 - selectedQuestions.length > 0
                      ? `Select ${6 - selectedQuestions.length} more question${6 - selectedQuestions.length !== 1 ? 's' : ''}`
