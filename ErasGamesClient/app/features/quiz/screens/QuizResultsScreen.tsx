  ...
  return (
    <View style={[styles.container, {backgroundColor: theme.colors.background}]}>
      ...
      <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
          ...
          <View style={styles.breakdownList}>
            ...
            <View style={styles.breakdownItem}>
              ...
              <Text style={[styles.breakdownValue, {color: theme.colors.success}]}>
                {breakdown.speedMultiplier?.toFixed(1)}x
              </Text>
            </View>
            ...
            <View style={styles.breakdownItem}>
              ...
              <Text style={[styles.breakdownValue, {color: theme.colors.success}]}>
                {breakdown.earlyMultiplier?.toFixed(1)}x
              </Text>
            </View>
            ...
            <View style={styles.breakdownItem}>
              ...
              <Text style={[styles.breakdownValue, {color: theme.colors.primary}]}>
                {breakdown.totalQuestionPoints} pts
              </Text>
            </View>
            ...
            <View style={[styles.breakdownItem, styles.totalItem]}>
              <Text style={[styles.breakdownLabel, styles.totalLabel, {color: theme.colors.text}]}>
                Total Score
              </Text>
              <Text style={[styles.breakdownValue, styles.totalValue, {color: getScoreColor(finalScore)}]}>
                {finalScore.toLocaleString()}
              </Text>
            </View>
          </View>
        ...
        {/* Timing Details */}
        {(breakdown.unusedSeconds > 0 || breakdown.minutesEarly > 0) && (
          <Card style={styles.detailsCard}>
            ...
            {breakdown.speedMultiplier > 1 && (
              <View style={styles.detailItem}>
                <Text style={[styles.detailLabel, {color: theme.colors.textSecondary}]}>
                  ⚡ Speed multiplier applied ({breakdown.speedMultiplier.toFixed(1)}x)
                </Text>
            ...
            {breakdown.earlyMultiplier > 1 && (
              <View style={styles.detailItem}>
                <Text style={[styles.detailLabel, {color: theme.colors.textSecondary}]}>
                  🚀 Early completion multiplier ({breakdown.earlyMultiplier.toFixed(1)}x)
                </Text>
                <Text style={[styles.detailValue, {color: theme.colors.success}]}>
                  Completed {breakdown.minutesEarly} minutes early
                </Text>
              </View>
            )}
            
            {breakdown.unusedSeconds > 0 && (
              <View style={styles.detailItem}>
                <Text style={[styles.detailLabel, {color: theme.colors.textSecondary}]}>
                  ⏱️ Time remaining
                </Text>
                <Text style={[styles.detailValue, {color: theme.colors.textSecondary}]}>
                  {breakdown.unusedSeconds} seconds unused
                </Text>
              </View>
            )}
          </Card>
