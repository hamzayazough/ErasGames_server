    ...
    <View style={styles.container}>
      ...
      <View style={styles.matchingGrid}>
        <View style={styles.column}>
          ...
          {question.prompt.left?.map((item) => {
            const hasMatch = (selectedAnswer || {})[item];
            const textColor = showCorrect && correctAnswer ? 
              (correctAnswer[item] === (selectedAnswer || {})[item] ? theme.colors.textOnPrimary : theme.colors.textOnPrimary) :
        ...
        <View style={styles.column}>
          ...
          {question.prompt.right?.map((item) => {
